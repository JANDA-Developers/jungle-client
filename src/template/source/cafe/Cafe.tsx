        ...
        <>
            ...
            <div id="cafe_1" className="page_main">
                ...
                <div className="mainSe1">
                    ...
                    <InfoSubmitModal {...arrayEditModalKit("section1_array", editModalHook)}/>
                    <Add {...arrAddKit("section1_array", editModalHook)} />
                </div>
                    ...
                    <section className="mainSe3__imgWrap">
                        ...
                        <section className="mainSe3__textWrap" data-aos="fade-up">
                            ...
                            <div className="mainSe3__btnWrap">
                                <A {...linkEdit("section3_btnLink")} 
                                    className="mainSe3__btn">
                                    <span className="mainSe3__btnText" {...edit("section3_btnText")}></span>
